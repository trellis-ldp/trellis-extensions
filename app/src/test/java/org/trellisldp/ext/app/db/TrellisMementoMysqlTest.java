...
public class TrellisMementoMysqlTest extends AbstractApplicationMementoTests {

    private static final Logger LOGGER = getLogger(TrellisMementoMysqlTest.class);
